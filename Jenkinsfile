...
def promoteQA () {
	...
	openshiftDeploy(depCfg: 'app-qa', namespace: 'dias2', verbose: 'false', waitTime: '10', waitUnit: 'min')
...
def promotePROD () {
	...
	openshiftDeploy(depCfg: 'app-prod', namespace: 'dias2', verbose: 'false', waitTime: '10', waitUnit: 'min')
